...
from .views import (
    ...
    CatalogHomeView,
    ProductDeleteView,
    ProductUpdateView, CategoryListView, ProductsByCategoryView,
)
...
urlpatterns = [
    ...
    path("product/<int:pk>/", cache_page(60)(CatalogDetailView.as_view()), name="product_info"),
    ...
    path('category/<int:category_id>/products/', ProductsByCategoryView.as_view(), name='category_products'),
